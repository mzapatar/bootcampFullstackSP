...
public class Challenge1 {
	...
	public static void main(String[] args) {
		...
		while (ten_digit_number == null) {
			System.out.println("The requested type '" + type + "' is not valid. Please type 'Type A' or 'Type B': ");
			type = sc.nextLine();
			ten_digit_number = Random10DigNumber(type);
		} 
	...
	//Method to generate two types of 10-digit pseudo-random numbers (Type A starts in 54 and Type B starts in 08. Any other type will return null.) 
	public static String Random10DigNumber(String type) {
		...
		boolean checka = type.toLowerCase().contains("a");
		
		boolean checkb = type.toLowerCase().contains("b");
